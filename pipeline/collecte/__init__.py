"""Collecte des sources (sous-lots C1, C1-bis et C3) : téléchargement poli, archivage, manifestes.
...
`lien_archive.archive_url_de` résout le lien effectif. Un enregistrement audio ou vidéo est copié
par yt-dlp (`media.py`, C3) au lieu d'un téléchargement HTTP ; le reste du flux est le même.
