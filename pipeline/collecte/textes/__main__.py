...
service. Codes de sortie : 0 si chaque contenu est extrait, déjà extrait ou en attente de C3 ;
1 si au moins un contenu est refusé (type inconnu, copie locale absente ou altérée, PDF sans couche
texte, encodage non déclaré…).
"""
...
def principal(arguments: Sequence[str]) -> int:
    ...
    deps = Dependances(options.racine, HorlogeSysteme(), extraire_pdf, extraire_html)
