...
- 0.10, 2026-09-25 : notification des campagnes. Section 4 : la notification automatique part par courriel depuis l'adresse dédiée, vers la seule adresse de contact générique publiée par la campagne, et chaque envoi est journalisé et publié. Section 10 : traitement correspondant ; le contestataire reçoit sa réponse depuis la boîte dédiée, et son adresse n'entre dans aucun fichier du projet.
