/**
 * `pnpm schemas` — valide les 117 exemples de `schema/exemples/` contre `schema/exemples/manifeste.json`
 * et les vingt schémas contre le méta-schéma draft 2020-12. Fait partie de `pnpm check`
