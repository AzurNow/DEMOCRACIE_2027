/**
 * `pnpm schemas` — valide les 55 exemples de `schema/exemples/` contre `schema/exemples/manifeste.json`
 * et les douze schémas contre le méta-schéma draft 2020-12. Fait partie de `pnpm check`
