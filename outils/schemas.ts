/**
 * `pnpm schemas` — valide les 70 exemples de `schema/exemples/` contre `schema/exemples/manifeste.json`
 * et les seize schémas contre le méta-schéma draft 2020-12. Fait partie de `pnpm check`
