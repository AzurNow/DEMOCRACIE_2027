/**
 * `pnpm schemas` — valide les 110 exemples de `schema/exemples/` contre `schema/exemples/manifeste.json`
 * et les dix-neuf schémas contre le méta-schéma draft 2020-12. Fait partie de `pnpm check`
