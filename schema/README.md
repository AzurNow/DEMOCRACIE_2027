...
`exemples/manifeste.json` liste les 117 exemples avec, pour chacun, le résultat attendu de la
...
depuis, `pnpm check` rejoue le tout : 20 schémas au registre, 117/117 exemples conformes au manifeste. Le runner vit dans `outils/schemas.ts` (ajv 8.20.0 et
